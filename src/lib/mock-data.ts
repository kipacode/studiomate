...
export const mockUsers: User[] = [
  ...
  },
  {
    ...
    name: "Bayu Saputra",
    username: "bayu",
    email: "bayu@kipaworks.studio",
    password: "hashed",
    role: "intern",
    status: "active",
    avatar: "",
    internshipStart: "2026-04-01",
    internshipEnd: "2026-09-30",
    homeLat: -7.969,
    homeLng: 112.628,
    homeLabel: "Rumah Blimbing",
